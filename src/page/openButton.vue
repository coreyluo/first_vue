    ...
    <div class="layout">
        ...
        <Layout :style="{marginLeft: '200px'}">
          ...
          <template>
            ...
            <div>
              <Button v-if="!openPeakSell"  type="primary" @click="changeButton(26)">5亿以上下单已关闭,请开启</Button>
              <Button v-if="openPeakSell"  type="error" @click="changeButton(26)">5亿以上下单已开启,请关闭</Button>
