...
<template>
    <div class="layout">
        <Sider :style="{position: 'fixed', height: '100vh', left: 0, overflow: 'auto'}">
            <Menu active-name="1-22" theme="dark" width="auto" :open-names="['1']" @on-select="routeTo">
                <Submenu name="1">
                    <template slot="title">
                    ...
                    <div>
                      是否扫版:&nbsp&nbsp
                        <select id="sex" name = param3  v-model="param3">
                          <option value="1">扫版</option>
                          <option value="0">不扫版</option>
                      </select>
                    </div>
                    <div>
...
<script>
   export default {
        ...
        methods: {
            ...
            deleteRadical(id){
                this.$api.get('singular/radicalDragonPool/deleteOne', {id:id}, r => {
                  location.reload()
                })
            },
